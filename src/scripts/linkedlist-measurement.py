...
def test(data: list, setup_name: str, type_files: str):
    ...
    test_insert(
        data, test_linkedlist, f"measurements/LinkedList-{setup_name}-insertion-{type_files}.txt")

    test_search(
        data, test_linkedlist, f"measurements/LinkedList-{setup_name}-search-{type_files}.txt")
    
    test_deletion(
        data, test_linkedlist, f"measurements/LinkedList-{setup_name}-deletion-{type_files}.txt")
